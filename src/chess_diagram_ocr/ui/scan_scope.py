...
class ScanScopeDialog(tk.Toplevel):
    ...
    def _build(self) -> None:
        ...
        self.radio_aberto.pack(anchor=tk.W, pady=(8, 0))
        ...
        self.radio_escolher.pack(anchor=tk.W, pady=(4, 0))
        ...
        self.radio_pasta.pack(anchor=tk.W, pady=(4, 0))
        ...
        self.btn_ok = ttk.Button(rodape, text="Varrer", command=self.confirm)
