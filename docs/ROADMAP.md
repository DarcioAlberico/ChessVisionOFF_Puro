...
| a janela abaixo de 600 linhas | **651** (477 de código) | **1.258**, e o arquivo dobrou depois da decomposição — ver S-136. O corte do Tk (S-506) trocou o arquivo vigiado: era o `app_tkinter.py` com 2.327 linhas, é `qt/janela.py` com 1.193, e a diferença é a camada pura de `ui/` sendo chamada em vez de reescrita |
